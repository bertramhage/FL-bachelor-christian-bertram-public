...
def main(no_fl: bool = False,
         ...
         mimiciii_path: str = 'gs://fl-bachelor/mimiciii/in-hospital-mortality.parquet',
         gcp_credentials: str = 'assets/credentials/bachelor-453811-676473e4370b.json',
         local_ep: int = 10,
         lr: float = 0.001,
         momentum: float = 0.5,
         seed: int = 42,
